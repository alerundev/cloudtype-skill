...
1. 최소 페이로드로 PUT
   ...
   ```
2. 빌드 로그 스트리밍 (`wss .../project/build/logs`)
3. 빌드 성공 시 실행 로그 스트리밍 (`wss .../project/logs`)
4. ready 상태와 entrypoint URL 을 사용자에게 보고
